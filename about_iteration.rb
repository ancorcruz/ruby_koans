...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # It passes an enumerable through a block storing the result of each
    # iteration in the first parameter of the block and returning it as
    # result in the last iteration. The first parameter takes as value
    # the inject argument in the very first iteration.
  end
  ...
  #
  # Open file scope is limited to the block. When the block finish
