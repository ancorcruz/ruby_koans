...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Ruby provides send first, but as send could be overwrited for some reason the
    # method __send__ was added. __send__ won't be overwrited.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # It will cause issues in methods discovery process.
    #
    # NOTE:
    #
